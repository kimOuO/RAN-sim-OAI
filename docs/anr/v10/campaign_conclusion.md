...
| 6 | Xn TNL | **全循環** | 08-25 全自動輪:FLAG_SET 16:07:25 → CLEAR 16:42:59 → RECOVERED 17:07:10(succ 0.9)。08-26 劇本自動化輪:16:17:09 止血 att 6→0 → 16:32:01 CLEAR → 16:55:02 RECOVERED(succ 0.94);**該輪 xn=true 為人工補**(時間軸隨 CU 15:33 重啟死亡),故機制全過但「無人值守全鏈」不計入該輪 |
