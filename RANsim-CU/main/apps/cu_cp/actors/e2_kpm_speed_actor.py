"""E2 KPM sim-speed endpoint — Dashboard 切 DU tick 速度時順便同步 KPM。"""
...
from main.apps.cu_cp.services.optional.e2 import sim_speed
from main.utils.response import error_response, success_response


class E2KpmSpeedActor:
    @staticmethod
    @csrf_exempt
    ...
    def set(request: HttpRequest):
        ...
        return success_response({"sim_speed_x": applied}, "KPM sim speed updated")

    @staticmethod
    @csrf_exempt
    @require_http_methods(["POST", "GET"])
    def read(request: HttpRequest):
        return success_response({"sim_speed_x": sim_speed.get_speed()}, "KPM sim speed")
